...
public class Db2DbProperties extends PropertiesBase implements DbProperties{
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	private String className = this.getClass().getName();
	private final static String FILE_NAME = "db2.db.properties";
	...
	public Db2DbProperties() throws Exception {
		super(FILE_NAME);
	}
