...
public class OracleDbProperties extends PropertiesBase implements DbProperties{
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	private String className = this.getClass().getName();
	private final static String FILE_NAME = "oracle.db.properties";
	...
	public OracleDbProperties() throws Exception {
		super(FILE_NAME);
	}
	...
	public String toString() {
		...
		builder.append("Db2DbProperties [logger=");
