...
public class MsKeyColumnUsageDao extends SqlBaseDao<MsKeyColumnUsageEo>{
	private static final String CONSTRAINT_NAME_PRIMARY = "%PK_%";
	public MsKeyColumnUsageDao() throws Exception {
		super();
	}
	...
	@Override
	public List<MsKeyColumnUsageEo> select(Object criteriaObj) throws Exception {
		List<MsKeyColumnUsageEo> results = null;
		...
		try{
			...
			results = new ArrayList<MsKeyColumnUsageEo>();
			MsKeyColumnUsageCriteria criteria = (MsKeyColumnUsageCriteria) criteriaObj;
			if (this.conn == null){
			...
			if (criteria != null){
				int count = 0;
				{
					...
					sbSql.append("k.CONSTRAINT_NAME like ? ");
			...
			while (rs.next()){
				MsKeyColumnUsageEo rsObj = new MsKeyColumnUsageEo();
				...
				Integer ordinalPositionLong = (Integer) rs.getObject("ORDINAL_POSITION");
	...
	@Override
	public void update(MsKeyColumnUsageEo eo) throws Exception {
		// TODO Auto-generated method stub
		
	}

	@Override
	public MsKeyColumnUsageEo create(MsKeyColumnUsageEo eo) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public void delete(MsKeyColumnUsageEo eo) throws Exception {
		// TODO Auto-generated method stub
